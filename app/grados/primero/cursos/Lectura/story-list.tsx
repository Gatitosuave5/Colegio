        ...
        {stories.map((story) => {
          ...
          return (
            <button
              ...
              >
                <Card
                  className="border-0 shadow-lg transition-all h-48 p-6 rounded-2xl cursor-pointer text-white relative overflow-hidden"
                  style={{
                ...
                >
                  {/* ✅ Capa oscura - se aclara al hover */}
                  <div className="absolute inset-0 bg-black/60 group-hover:bg-black/20 transition-all duration-300 rounded-2xl" />
