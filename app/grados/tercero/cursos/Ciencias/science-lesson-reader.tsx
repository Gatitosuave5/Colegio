...
export default function ScienceLessonReader({
  ...
  quizScore = 0,
  emoji = "📝",
  description = "Aprende sobre este tema",
  image = "https://placeholder.svg?height=400&width=600&query=educational illustration",
}: {
  lesson: Lesson
  onQuizStart: () => void
  onGamesStart: () => void
    ...
    <div>
      ...
      <Card className="bg-gradient-to-b from-green-50 to-white border-0 shadow-lg p-8 mb-8 rounded-2xl">
        ...
        <div className="mt-8 p-6 bg-gradient-to-r from-green-100 to-emerald-100 rounded-xl border-2 border-green-300">
          <p className="text-center text-gray-900 font-bold text-lg">✨ ¡Empieza cuando estés listo! ✨</p>
        </div>
      </Card>
