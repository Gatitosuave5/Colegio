...
export default function OrderGame({ topic, onBack }) {
  ...
  const generateRound = () => {
    ...
    if (topic.id === "restas-llevadas") {
      const operations = [
        { val: 17, display: "32-15" },
        { val: 27, display: "40-13" },
        { val: 25, display: "52-27" },
        { val: 25, display: "43-18" },
        { val: 18, display: "30-12" },
      ];
    ...
    } else if (topic.id === "mitad-doble") {
      const numbers = [
        { val: 5, display: "Mitad de 10" },
        { val: 16, display: "Doble de 8" },
        { val: 10, display: "Mitad de 20" },
        { val: 18, display: "Doble de 9" },
        { val: 8, display: "Mitad de 16" },
      ];
    ...
    } else if (topic.id === "horas-minutos") {
      const times = [
        { val: 24, display: "Horas en un día" },
        { val: 60, display: "Minutos en una hora" },
        { val: 30, display: "Minutos en media hora" },
        { val: 12, display: "Horas hasta mediodía" },
        { val: 1440, display: "Minutos en un día" },
      ];
      newItems = times.map((time, idx) => ({
        id: `time-${idx}`,
        value: time.val,
        displayValue: time.display,
      }));
    } else if (topic.id === "pares-impares") {
      const numbers = [
        { val: 1, display: "1 - ¿Qué es?" },
        { val: 2, display: "2 - ¿Qué es?" },
        { val: 7, display: "7 - ¿Qué es?" },
        { val: 12, display: "12 - ¿Qué es?" },
        { val: 19, display: "19 - ¿Qué es?" },
      ];
      newItems = numbers.map((num, idx) => ({
        id: `num-${idx}`,
        value: num.val,
