...
import { topicsData2 } from "./topicsData";
import TopicReader from "./topic-reader";
import TopicQuiz from "./topic-quiz";
import TopicGames from ".";

export const mathStoryMapGrade2: Record<string, string> = {
  "sumas-1-20-2do": "sumas-1-20-2do",
  "restas-1-20-2do": "restas-1-20-2do",
  "sumas-llevada-2do": "sumas-llevada-2do",
  "restas-llevada-2do": "restas-llevada-2do",
  "tablas-2-3-2do": "tablas-2-3-2do",
  "figuras-2d-2do": "figuras-2d-2do",
  "simetria-2do": "simetria-2do",
  "problemas-sr-2do": "problemas-sr-2do",
  "numeros-200-2do": "numeros-200-2do",
  "patrones-2do": "patrones-2do",
};
...
export default function MatematicasModule2({ onBack, contenidosActivos }: MatematicasModuleProps) {
  const [currentView, setCurrentView] = useState<View>("list");
  const [selectedTopic, setSelectedTopic] = useState<any | null>(null);

  const topics = contenidosActivos
  .map(c => mathStoryMapGrade2[c.storyId])   // convierte storyId a topicId
  .filter(Boolean)                           // elimina null / undefined
  .map(topicId => topicsData2[topicId]); 
